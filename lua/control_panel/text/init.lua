-- The code in this file is a modified version of a file from https://github.com/folke/lazy.nvim
-- Apache License
...
local Config = {
  ns = vim.api.nvim_create_namespace("control-panel"),
  options = { ui = { wrap = true } },
}
local Text = {}
...
function Text:concat(tail)
  local newtext = Text.new()
  newtext._lines = vim.deepcopy(self._lines)

  vim.list_extend(newtext._lines, tail._lines)
